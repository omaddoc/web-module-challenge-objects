...
console.log(
  "Task 1:",
  createMenuItem("Pizza", 30, "Lunch"),
  createMenuItem("Tofu", 4, "Dinner"),
...
export const burger = {
  ...
  discount: function (person) {
    ...
    let newPrice = this.price - discount * this.price;
    return newPrice;
  },
};
...
reviews.push({
  name: "Orlando",
  rating: 2,
  feedback: "I just want to say Hello World",
});
console.log("Task 4", reviews[reviews.length - 1]);
/* 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 Task 5: 🚀🚀🚀🚀🚀🚀🚀🚀🚀🚀 
...
// console.log(reviews.filter((name) => name === "Reyna"));
